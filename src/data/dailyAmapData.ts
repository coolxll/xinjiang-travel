...
export const dailyAmapSchedules: Record<string, DayAmapSchedule> = {
    ...
    destinations: [
      {
        ...
        elevation: '648m',
        tagline: '直飞航班 22:00 准时抵达 T2 航站楼',
  ...
  'day-10': {
    ...
    title: '乌鲁木齐天山机场 T2 → 上海浦东 T2 (圆满收官满载回忆返沪)',
    tagline: '清晨 05:00 专车抵机场，搭乘早班机破晓起飞，13:45 顺利抵达上海浦东 T2',
    startPoint: '迎宾路酒店',
    endPoint: '上海浦东机场T2',
    distanceKm: 0,
