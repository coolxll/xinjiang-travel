...
export const TOTAL_JOURNEY_KM = 2225;
...
export const dailyAmapSchedules: Record<string, DayAmapSchedule> = {
  ...
  'day-5': {
    ...
    tagline: '国庆当天逆向错峰北上，打卡五彩滩绝美日落，夜宿阿尔泰山脚慢生活特色小镇冲乎尔',
    startPoint: '乌尔禾镇',
    endPoint: '冲乎尔镇',
    distanceKm: 290,
    durationText: '约3.5小时高速与景观公路',
    cumulativeKmStart: 1130,
    cumulativeKmEnd: 1420,
    ...
    destinations: [
      ...
      {
        id: 'd5-night-market',
        name: '布尔津美食街 (额尔齐斯河畔冷水鱼)',
        category: 'food',
        categoryLabel: '边城午餐',
        icon: '🐟',
        coords: [47.7020, 86.8650],
        elevation: '470m',
        tagline: '必尝特色额河冷水烤狗鱼、五道黑、手抓肉与原酿格瓦斯',
        tips: '烤狗鱼肉质细嫩刺少，配上冰镇格瓦斯是一绝，为下午进山蓄力',
      ...
      {
        id: 'd5-chonghuer-town',
        name: '冲乎尔国家级慢生活小镇 / 雾凇小镇',
        category: 'scenic',
        categoryLabel: '山脚慢游',
        icon: '🌲',
        coords: [48.1500, 86.9200],
        elevation: '650m',
        tagline: '阿尔泰山脚静谧小镇，金秋红叶与图瓦风情，避开国庆喧嚣',
        tips: '沿 S232 浅山区慢速行驶，小镇空气清新，晚上观赏璀璨星空',
  ...
  'day-6': {
    ...
    title: '冲乎尔镇 → 贾登峪 (仅70km) → 喀纳斯核心三湾与湖区 → 贾登峪综合服务区',
    tagline: '🔥 喀纳斯核心高光日！从冲乎尔出发仅 1h 抵达贾登峪，抢首批入园漫游神仙湾月亮湾卧龙湾',
    startPoint: '冲乎尔镇',
    endPoint: '贾登峪 / 喀纳斯',
    distanceKm: 70,
    durationText: '自驾山路仅1h + 景区内深度游览6h',
    cumulativeKmStart: 1420,
    ...
    destinations: [
      {
        ...
        coords: [48.1500, 86.9200],
        elevation: '650m',
        tagline: '07:30 从容出发，沿 S232 驶向贾登峪，路程仅 70km',
        tips: '山路晨间慢行，路况优良铺装公路',
        amapUrl: 'https://uri.amap.com/marker?position=86.9200,48.1500&name=%E5%86%B2%E4%B9%8E%E5%B0%94%E5%87%BA%E5%8F%91%E7%82%B9',
        navSearchQuery: '冲乎尔镇',
        isPrimary: false
      },
      {
  ...
  'day-8': {
    ...
    tagline: '南下穿越准噶尔盆地！探访美食之都昌吉小吃街，品尝九碗三行子与地道风味，开启都会慢游',
    startPoint: '阿勒泰市',
    endPoint: '昌吉市 / 乌鲁木齐',
    distanceKm: 400,
    durationText: 'S21沙漠高速约4.5小时坦途',
    cumulativeKmStart: 1765,
    cumulativeKmEnd: 2165,
    ...
    destinations: [
      {
        ...
        coords: [47.8484, 88.1318],
        elevation: '887m',
        tagline: '睡到自然醒 09:30 启程，沿 S21 阿乌沙漠高速直通南下',
      ...
      {
        id: 'd8-changji-street',
        name: '昌吉回民小吃街 (名小吃总汇)',
        category: 'food',
        categoryLabel: '美食地标',
        icon: '🍲',
        coords: [44.0150, 87.3080],
        elevation: '600m',
        tagline: '全疆最负盛名的小吃聚集地！品尝九碗三行子、回民油糕、丸子汤、椒麻鸡',
        tips: '集中了数十家非物质文化遗产老字号，明码标价，性价比极高',
        amapUrl: 'https://uri.amap.com/marker?position=87.3080,44.0150&name=%E6%98%8C%E5%90%89%E5%9B%9E%E6%B0%91%E5%B0%8F%E5%90%83%E8%A1%97',
        navSearchQuery: '昌吉回民小吃街',
        isPrimary: true
      },
      {
        id: 'd8-tingzhou-park',
        name: '昌吉庭州生态绿谷 / 乌市红山公园',
        category: 'scenic',
        categoryLabel: '都会慢游',
        icon: '🌳',
        coords: [44.0300, 87.3200],
        elevation: '610m',
        tagline: '水系绿意盎然的城市生态公园，傍晚悠闲散步体验北疆慢生活',
        tips: '公园面积广大，空气清新，适合散步舒缓长途自驾疲惫',
        amapUrl: 'https://uri.amap.com/marker?position=87.3200,44.0300&name=%E5%BA%AD%E5%B7%9E%E7%94%9F%E6%80%81%E7%BB%BF%E8%B0%B7',
        navSearchQuery: '昌吉庭州生态绿谷',
        isPrimary: false
      },
      {
        id: 'd8-hotel',
  ...
  'day-9': {
    ...
    endPoint: '乌鲁木齐天山国际机场',
    distanceKm: 60,
    durationText: '市区游览与采买 + 傍晚机场还车交接',
    cumulativeKmStart: 2165,
    cumulativeKmEnd: 2225,
    ...
    destinations: [
      {
        ...
        coords: [44.0200, 87.3100],
        elevation: '600m',
        tagline: '睡到自然醒 09:30 启程，前往乌鲁木齐市中心开启采买慢游',
        tips: '昌吉至乌鲁木齐市区车程仅 35 分钟，走乌昌快速路直达',
        amapUrl: 'https://uri.amap.com/marker?position=87.3100,44.0200&name=%E6%98%8C%E5%90%89%E5%87%BA%E5%8F%91%E7%82%B9',
        navSearchQuery: '昌吉市区',
        isPrimary: false
      },
      {
      ...
      },
      {
        ...
        categoryLabel: '老街风味',
        icon: '🥟',
        coords: [43.7810, 87.6250],
        elevation: '805m',
        tagline: '乌鲁木齐地道美食聚集地！现烤和田烤包子、老牌手工冰淇淋、面肺子米肠子',
        tips: '大巴扎步行 10 分钟即达，老字号扎堆，边走边吃极具烟火气',
        amapUrl: 'https://uri.amap.com/marker?position=87.6250,43.7810&name=%E9%A2%86%E9%A6%86%E5%87%84',
        navSearchQuery: '乌鲁木齐领馆巷',
        isPrimary: true
      },
      {
        id: 'd9-museum',
        ...
        categoryLabel: '历史瑰宝',
        icon: '🏛️',
        coords: [43.8200, 87.5850],
        elevation: '780m',
        tagline: '镇馆之宝“楼兰美女”干尸与“五星出东方利中国”汉代锦护膊',
        tips: '需提前在官方微信公众号预约门票，馆内空调舒适，参观约 1.5–2 小时',
        amapUrl: 'https://uri.amap.com/marker?position=87.5850,43.8200&name=%E6%96%B0%E7%96%86%E5%8D%9A%E7%89%A9%E9%A6%86',
        navSearchQuery: '新疆维吾尔自治区博物馆',
        isPrimary: false
      },
      {
        id: 'd9-wash-gas',
