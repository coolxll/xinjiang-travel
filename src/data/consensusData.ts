...
export const decisionItems: DecisionItem[] = [
  {
    ...
    iconName: 'CloudFog',
    context: '禾木清晨薄雾笼罩木屋虽美，但需要06:00-06:30在接近0°C的低温下摸黑爬上哈登平台。部分成员注重摄影，部分成员更需要充足睡眠恢复体力。',
    optionA: {
      title: '🌅 摄影早起派 (06:30起床)',
    ...
    consensusRecommendation: '【共识原则】：完全自愿，绝不绑架！想早起的人结伴去看，想睡的人继续睡，10:00在村内集合共同开始白天的白桦林徒步与骑马。',
  ...
  },
  {
    ...
    iconName: 'Home',
    context: '国庆期间禾木村内小木屋溢价严重（往往数千元/晚），且9/30早上出村需要排队挤区间车40-60分钟。而9/29白天大家已经完整体验了村内白天的所有风景。',
    optionA: {
      title: '🏡 连住2晚村内木屋',
    ...
    optionB: {
      title: '🚗 傍晚搬迁至入口服务区（推荐）',
      description: '9/29白天完整玩完，傍晚17:00坐区间车出村，住入口服务区酒店。',
      pros: ['住宿成本降低50%以上', '9/30清晨直接开车直奔贾登峪，快1.5小时抢先入园'],
      cons: ['9/29傍晚需花40分钟收拾行李换乘出村']
    },
    consensusRecommendation: '【共识建议】：根据临行前房价比价和体力投票。若村内差价>1000元/间，强烈建议傍晚搬至入口服务区，省钱又省次日排队时间！',
    bottomLine: '无论选哪种，9/29白天的游玩时间完全一致，不影响任何白天的禾木景点。'
  },
  {
    id: 'decision-guanyu',
    ...
    iconName: 'Compass',
    context: '10/1恰逢国庆客流高峰。观鱼台需单独排队购买接驳车票并攀爬1068级台阶。若遇排队人数过多，往返排队往往超过2-3小时。',
    optionA: {
      title: '🧗 坚持排队打卡观鱼台',
    ...
    optionB: {
      ...
      description: '若排队>45分钟果断放弃，把时间留给神仙湾、月亮湾、卧龙湾木栈道与湖区游船。',
      pros: ['沉浸式亲水慢游，避开人挤人', '光线正好拍照更美，旅行幸福感极高'],
      cons: ['未能登顶俯瞰全景']
    },
    consensusRecommendation: '【共识原则】：以现场人流排队时间为唯一准绳。排队≤30分钟可上，排队>45分钟果断放弃！喀纳斯核心是整体光影与山水，不是执着打卡。',
  ...
  },
  {
    ...
    context: 'G681阿禾公路穿越阿尔泰深山，9月底已有降雪或结冰可能。如遇官方交警发布临时交通管制或暴风雪黄色预警，必须启动备选方案。',
    optionA: {
      title: '🛣️ 正常放行：畅游G681阿禾公路（首选）',
      description: '8:45阿勒泰加满油出发，9:30前进入阿禾公路，5-6小时边走边玩直达禾木。',
      pros: ['体验2026最新绝美景观公路', '少绕路，移步换景'],
      cons: ['受天气动态影响较大，需临行复核']
    },
    optionB: {
      title: '🔄 备选应急：阿勒泰 → 布尔津 → 禾木（备选）',
      description: '遇管制时改走S319/G217国道经布尔津前往禾木，全线为高等级铺装主干道。',
      pros: ['全天候通行能力强，安全保障极高', '可顺路在布尔津品尝冷水鱼午餐'],
      cons: ['里程增加约60km，错过阿禾公路新景观']
    },
    consensusRecommendation: '【共识底线】：山区规则高于既定行程！安全第一，绝不硬闯或抢行。9/28早晨根据阿勒泰交警权威通报一锤定音。',
