...
export const officialSources: OfficialSource[] = [
  ...
  },
  {
    ...
    verifiedDate: '2026-09-10',
    status: 'confirmed',
    statusText: '交通运输厅官网已核验'
  },
  {
    id: 's3',
    section: '阿禾公路 G681 景观通达性',
    ...
    status: 'confirmed',
    statusText: '兵团交通官媒已核验',
    isPolicy: true
  },
  {
    id: 's4',
    section: '阿禾公路每日通行放行时段与天气管制',
    publicRef: '7座及以下曾按9:30–15:00放行，后续根据降雪结冰动态调整',
    itineraryStandard: '10/3建议9:30前抵达检查站；临行前24h复核交警通告',
    url: 'https://www.xjmty.com/sh/2026/04-25/nav-42-xDLVeAR1.html',
    note: '官方明确要求进入前必须在贾登峪加满油/充满电；山区恶劣天气可临时交通管制',
    verifiedDate: '2026-09-14',
    status: 'recheck_before_departure',
    statusText: '⚠️ 出发前24h重新确认 (强时效管制)',
    isPolicy: true
  },
  {
    id: 's5',
  ...
  {
    id: 's12',
    section: '赛里木湖自驾 8/20 官方新规（按车收费与限流预约）',
    publicRef: '2026-08-20 起自驾按车收费 (5座120元/车)，提前 3 天自驾预约',
    itineraryStandard: '9/25 00:00 开放抢约 9/28 自驾车辆配额，备好行驶证',
    ...
    verifiedDate: '2026-09-12',
    status: 'recheck_before_departure',
    statusText: '⚠️ 出发前重新确认 (9/25抢约自驾票)',
    isPolicy: true
  },
  {
    id: 's13',
