...
export const routePoints: ExtendedRoutePoint[] = [
  ...
  {
    id: 4,
    name: '禾木岔口 / 禾贾公路连通点 (阿禾终点)',
    coords: [48.57, 87.43],
    dayText: '9/28',
    description: '阿禾公路与禾贾公路交汇处，阿禾天路全景平替禾木，直通贾登峪',
    category: 'transfer',
    elevation: '1,120m',
    tips: '阿禾公路已饱览 90% 秋色精华，无需进村换乘，直接顺接禾贾公路自驾前往贾登峪',
...
export const mapDaySchedules: MapDaySchedule[] = [
  ...
  },
  {
    ...
    date: '9/28',
    shortLabel: 'D2 阿禾天路',
    title: '阿勒泰市 → G681阿禾公路 (平替禾木) → 贾登峪',
    routeLabel: 'G681阿禾天路 209km ｜ 全景平替禾木 ｜ 直通禾贾公路 ｜ 宿贾登峪',
    ...
    description: '08:45 出发，穿越 209km 阿禾景观公路。阿禾天路饱览 90% 以上阿尔泰秋色，彻底不进村排队挤大巴，傍晚自驾 64km 禾贾公路直通贾登峪入住！'
  },
  {
    key: 'day-3',
    dayNumber: 3,
